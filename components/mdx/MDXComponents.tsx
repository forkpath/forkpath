...
const MDXComponents: MDXComponentsProps = {
	...
	h2: (props) => (
		<Heading level={2} className='text-3xl font-semibold mt-8 mb-6 border-b-2 border-gray-200 pb-2' {...props} />
	),
	...
	p: (props) => <p className='mt-6 mb-6 leading-relaxed text-gray-700 dark:text-gray-300' {...props} />,
	a: (props) => (
		<a
	...
	code: (props) => <code className='bg-gray-100 dark:bg-gray-700 rounded px-2 py-1 font-mono text-sm' {...props} />,
	pre: (props) => <pre className='rounded-lg p-4 overflow-x-auto my-4 bg-gray-100 dark:bg-gray-800' {...props} />,
	blockquote: (props) => (
		<blockquote className='pl-6 border-l-4 my-6 text-gray-600 dark:text-gray-400 italic' {...props} />
	),
	img: (props) => <img className='rounded-lg border-2 border-gray-200 my-6' {...props} alt='content' />,
